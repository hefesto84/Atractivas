 ...
 *
 * <p>This class is used by the {@link es.ubiqua.atractivas.GaleryActivity} samples.</p>
 */
public class GaleryPageFragment extends Fragment {
    /**
     * The argument key for the page number this fragment represents.
     */
	public YocAdManager _yocAdManagerb;
     ...
     */
    public static GaleryPageFragment create(int pageNumber) {
        GaleryPageFragment fragment = new GaleryPageFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		scroll.setOnEndScrollListener(
			new NoAutoScrollView.OnEndScrollListener() {
				@Override
...
//						Log.d( "action fragment_category", "Enter: handleMessage -> " + e.getMessage() );
		...
		imgLoader.DisplayImage( imagen.getUrl(), R.drawable.placeholder_detalle, (ImageView) rootView.findViewById(R.id.DetalleImagen) );

		((WebView) rootView.findViewById(R.id.DestalleFulltext)).loadData( HEADER + imagen.getTexto() + FOOTER, "text/html; charset=UTF-8", null );
